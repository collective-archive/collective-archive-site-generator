...
objectTransformer = function(data) {
  ...
  var otherRelationships = _.reject(relationships, function (relationship) {
    return _.some(artists, function(artist) { return artist.id == relationship.id && artist.type == relationship.type });
  });
